...
PATENT_LENSES: Dict[str, List[Dict[str, str]]] = {
    "eeat_trust": [
        ...
        },
        {
            ...
            "label": "Generative Summaries for Search Results",
            "mechanism": "grounded LLM summary generation from multi-query retrieval — author trust and freshness affect citation selection",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us11886828b1-generative-summaries.md"),
        },
        {
            "patent_id": "US11875086B2",
            "label": "Using User Input to Adapt Search Results",
            "mechanism": "user acceptance and skip signals in dialogue re-rank trust — promotion and suppression carry forward",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us11875086b2-user-input-adapt-results.md"),
        },
        {
            "patent_id": "WO2025102041A1",
            "label": "User Embedding Models for Personalization",
            "mechanism": "user history compressed to learned embeddings injected into LLM — historical engagement affects trust signals",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-wo2025102041a1-user-embedding-personalization.md"),
        },
    ],
    "entity_clarity": [
        {
        ...
        {
            "patent_id": "US20240037137A1",
            "label": "Media Consumption History",
            "mechanism": "cross-platform engagement signals re-rank entity knowledge cards — entity association via consumption patterns",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us20240037137a1-media-consumption-history.md"),
        },
        {
            "patent_id": "WO2024064249A1",
            "label": "Prompt-Based Query Generation for Diverse Retrieval",
            "mechanism": "LLM generates synthetic query-document pairs — entity coverage breadth determines retrieval candidate inclusion",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-wo2024064249a1-prompt-query-generation.md"),
        },
    ],
    "topical_authority": [
        {
        ...
        },
        {
            ...
            "label": "Text Ranking with Pairwise Ranking Prompting",
            "mechanism": "LLM head-to-head document comparison — differentiated topical depth beats generic keyword overlap",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us20250124067a1-pairwise-ranking-prompting.md"),
        },
        {
            "patent_id": "WO2024064249A1",
            "label": "Prompt-Based Query Generation for Diverse Retrieval",
            "mechanism": "synthetic sub-query fan-out — topic breadth determines whether a site enters multi-query retrieval candidates",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-wo2024064249a1-prompt-query-generation.md"),
        },
    ],
    "information_gain": [
        ...
        },
        {
            "patent_id": "US20250124067A1",
            "label": "Text Ranking with Pairwise Ranking Prompting",
            "mechanism": "pairwise LLM ranking directly rewards information gain — highly specific content wins head-to-head against generic pages",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us20250124067a1-pairwise-ranking-prompting.md"),
        },
    ],
    "ai_search_readiness": [
        ...
        },
        {
            "patent_id": "US11886828B1",
            "label": "Generative Summaries for Search Results",
            "mechanism": "AI Overview architecture — LLM summary grounded in multi-query retrieved documents; passage-level extractability required for citation",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us11886828b1-generative-summaries.md"),
        },
        {
            "patent_id": "US11769017B1",
            "label": "Generative Summaries for Search Results (v1)",
            "mechanism": "foundational AI Overview patent — grounded generation from retrieved docs, personalised by user context and expertise",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us11769017b1-generative-summaries-v1.md"),
        },
        {
            "patent_id": "US12189697",
            "label": "Informational Grounding with Generative Model",
            "mechanism": "LLM generates internal search query, retrieves docs, conditions final output on grounded prompt — content must survive passage extraction to be cited",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us12189697-informational-grounding.md"),
        },
    ],
    "landing_page_quality": [
        {
        ...
        },
        {
            "patent_id": "US11875086B2",
            "label": "Using User Input to Adapt Search Results",
            "mechanism": "dialogue-based suppression and promotion — bounce, skip, and re-query signals reduce landing page confidence score",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-us11875086b2-user-input-adapt-results.md"),
        },
        {
            "patent_id": "WO2025102041A1",
            "label": "User Embedding Models for Personalization",
            "mechanism": "personalised landing page relevance via user history embeddings — pages that misalign with user journey get demoted",
            "note_path": str(SEO_MEMORY_ROOT / "google-patent-wo2025102041a1-user-embedding-personalization.md"),
        },
    ],
}
