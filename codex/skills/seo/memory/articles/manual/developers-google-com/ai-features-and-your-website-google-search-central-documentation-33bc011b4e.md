...
scraped: 2026-05-19
published_on: 
tags: manual_ingest, dashboard, on_demand_capture, developers-google-com
topic: manual_ingest
...
Publisher Host: developers.google.com
Homepage: https://developers.google.com/
Original URL: https://developers.google.com/search/docs/appearance/ai-features
Published: unknown
Strength: Instant dashboard capture into durable squad memory.

## Capture Context
- Run ID: `20260519T091338Z`
...
Just like the rest of the search results page, sites appearing in AI features (such as AI Overviews and AI Mode) are included in the overall search traffic in Search Console . In particular, they're reported on in the Performance report , within the "Web" search type . Learn more about how AI Overviews and AI Mode are counted towards the overall data in Search Console, how to analyze traffic changes overall, and how to combine Search Console and Analytics data .
