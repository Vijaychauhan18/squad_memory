---
source: https://moz.com/blog/nearby-filter-local-google-serp
title: Is the Nearby Filter Nav Actually Making Google’s SERPs More Local?
scraped: 2026-03-23
...
Original URL: https://moz.com/blog/nearby-filter-local-google-serp
...
Hallmark does come up in the top 20 organic results, but the SERP entry takes you to an e-commerce page for ornaments for the main brand — it does not take the user to a location landing page for this local branch of the franchise listed in the local pack. Despite being the #1 local pack result, Amy’s Hallmark Shop is nowhere to be found in the top organic SERPs despite the “nearby” filter. The same goes for shop #2, specializing solely in Christmas decor. Its niche specialization should see it being listed at #1 in both the packs and the organic SERPs, but it is nowhere to be found below the pack. Finally, the big brand at #3 does come up at #1 in the top 20 organic results, but the organic result clicks to a generic inventory page on Target’s website, not the location landing page of the nearby store.

So, it would appear that the “nearby” filter really isn’t localizing the organic SERPs very much. They don’t reflect an accurate picture of local product availability and mainly favor remote brands beyond city borders, and they do not reiterate the entries in the local packs. So that brings up my next question.
...
And that’s why I’d like to ask readers to do me a favor. My experiment is relatively small. Could you add to it? If you have a moment to contribute to industry knowledge, please do a local search in your town or a city near you that brings up the “nearby” filter. It doesn’t have to be for Christmas ornaments. It could be for any type of merchandise. Select that filter and then run through these three questions:

What % of the organic top 20 features a local business within city borders?

What % of the product blocks in the organic top 20 feature a local business within city borders?

Are the top three local pack results reiterated anywhere in the top 20 organic results? *Be sure that the organic results actually click to the same location as the one shown in the local results rather than to a brand home page or ecommerce page.

Please @ me the results on X , and if you have a take of your own on whether the “nearby” filter is actually localizing any part of the SERPs so that local businesses in your town are more prominent or more transactional, please let me know. Thank you!

For now, my conclusion from this small experiment is that the “nearby” filter isn’t really localizing the organic results to any meaningful degree, meaning that the SERPs aren’t measurably more discoverable or transactional for local businesses within city borders. It’s disappointing if remote “bigness” is being favored over actual local diversity, creating a false picture of nearby choice.

Meanwhile, I want to study more examples of the impact the filter is having on “product blocks” because I suspect the filter may be meant to influence what appears in them, but I’m concerned that emphasis on big brands, across all the results, is enforcing a bias that runs contrary to the success of independently-owned local SMBs. It’s a dilemma I’d love to see addressed with new solutions on both the sides of the equation.
