...
Original URL: https://moz.com/blog/better-about-page
...
Telling your brand’s story is a great way to make your About page more memorable and relatable. Moz tells its story on the About page, and Hosting (formerly A2 Hosting) does that using a visual timeline:
...
Google now shows site names instead of domain names, so helping it correctly identify yours will likely help click-through and build brand recognizability
