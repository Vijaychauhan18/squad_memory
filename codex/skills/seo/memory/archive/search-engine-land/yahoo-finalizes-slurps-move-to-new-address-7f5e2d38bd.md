---
source: https://searchengineland.com/yahoo-finalizes-slurps-move-to-new-address-11389
title: Yahoo Finalizes Slurps Move To New Address
scraped: 2026-03-22
published_on: 2007-06-05
...
Original URL: https://searchengineland.com/yahoo-finalizes-slurps-move-to-new-address-11389
Published: 2007-06-05
Strength: industry coverage, rollout monitoring, search product and platform changes

## Summary
The Yahoo Search Blog announced the transition of Yahoo Slurp, Yahoo’s web crawler, from inktomisearch.com to crawl.yahoo.net is now complete. The IP addresses and the user-agent are remaining the same but the DNS lookup is different, it is now crawl.yahoo.net. This does not apply to other Yahoo crawlers, including Yahoo China, Yahoo Shopping, Yahoo Travel […]

## Extracted Body
The Yahoo Search Blog announced the transition of Yahoo Slurp, Yahoo’s web crawler, from inktomisearch.com to crawl.yahoo.net is now complete.

The IP addresses and the user-agent are remaining the same but the DNS lookup is different, it is now crawl.yahoo.net. This does not apply to other Yahoo crawlers, including Yahoo China, Yahoo Shopping, Yahoo Travel and other Yahoo crawlers that have their own user agents.
